...
detector = load_model('\\Users\\yunka\\Desktop\\New folder (3)\\fyp11\\faces_recognition\\facetracker.h5')
class Face_Register:
    ...
    def __init__(self):
        ...
        # Tkinter GUI
        self.win = tk.Tk()
        self.win.title("Employee Face Register")
        ...
        self.path_photos_from_camera = "faces_recognition/data/data_faces_from_camera/"
    ...
    def GUI_clear_data(self):
        ...
        if os.path.isfile("faces_recognition/data/features_all.csv"):
            os.remove("faces_recognition/data/features_all.csv")
    ...
    def GUI_get_input_name(self):
        ...
        #self.input_name_char = my_string
    ...
    def check_existing_faces_cnt(self):
        if os.listdir("faces_recognition/data/data_faces_from_camera/"):
    ...
    def process(self):
        ...
        if yhat[0] > 0.7: 
            ...
            x1, y1, x2, y2 = np.multiply(sample_coords, [self.current_frame.shape[1], self.current_frame.shape[0], self.current_frame.shape[1], self.current_frame.shape[0]]).astype(int)
        ...
        if ret:
            ...
            if len(faces) != 0: 
                ...
                for k, d in enumerate(faces):
                    ...
                    if (d.right() + self.ww) > 2000 or (d.bottom() + self.hh > 2000) or (d.left() - self.ww < 0) or (
                            d.top() - self.hh < 0):
                        #print(self.ww)
                        #print(d.right())
...
def main():
    ...
    Face_Register_con.GUI_get_input_name()
